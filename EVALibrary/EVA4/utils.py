...
def prepareData(root):
  ...
  depthimages.sort()
  #print(len(bgimages))
  #return([fgbgimages, maskimages, depthimages])
  dataset = list(zip(fgbgimages, maskimages, depthimages))
  #dataset = list(zip(fgbgimages[:25000], maskimages[:25000], depthimages[:25000]))
